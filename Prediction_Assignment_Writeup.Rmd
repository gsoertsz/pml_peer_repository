...
```{r eval=F, echo=F, results='asis', message=FALSE, error=FALSE, warning=FALSE, tidy=TRUE, tidy.opts=list(blank=FALSE, width.cutoff=60)}
...
testing_predictions <- predict(fit_rf3, newdata = raw_testing, type="raw")
```
